...
class ReadGamesByNameSearch extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            index: '',
...
export default ReadGamesByNameSearch;
/*
  <form>
                <label> Look Up A Game</label>

                <FormControl type="text" value={this.state.value} placeholder= onChange={this.handleChange}/>
                <FormControl.Feedback />
                <ReadGamesByNameSearch name={this.state.value}  />
            </form>
 ...
 <label > Look Up A Game</label>
                ...
                <ReadGamesByNameSearch name={this.state.name}/>
