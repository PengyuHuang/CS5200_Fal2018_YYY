...
class JoinEventStudent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            index: '',
    ...
    componentDidMount() {
        this.userService.user_find_not_joined_events_not_vip_service(this.props.user.id)
...
export default JoinEventStudent;